...
export default function HistoryDetailPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    if (!record) {
        return (
            <div className="flex-1 p-8 text-white text-center">
        ...
        <div className="flex-1 p-8 overflow-y-auto h-full text-white">
            <div className="max-w-5xl mx-auto space-y-8">
                ...
                <div className="flex flex-col gap-6">
                    <button
                        onClick={() => router.back()}
                        className="w-fit flex items-center gap-2 text-sm text-gray-500 hover:text-white transition-colors group cursor-pointer"
                    >
                ...
                <div className="grid grid-cols-1 gap-8">
                    ...
                    <div className="space-y-3">
                        <div className="flex items-center justify-between px-1">
                            <label className="text-xs font-bold uppercase tracking-widest text-gray-500">Original Input</label>
                            <button
                                onClick={() => handleCopy(record.original_text)}
                                className="text-[10px] font-bold uppercase tracking-widest text-gray-500 hover:text-blue-400 transition-colors flex items-center gap-1 cursor-pointer"
                            >
                                <Copy className="w-3 h-3" /> Copy
                            </button>
                        </div>
                        <div className="p-6 rounded-[20px] bg-white/5 border border-white/10 text-gray-300 leading-relaxed whitespace-pre-wrap min-h-[100px]">
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="p-6 rounded-[20px] bg-blue-500/[0.03] border border-blue-500/20 shadow-inner text-white leading-relaxed whitespace-pre-wrap min-h-[100px]">
