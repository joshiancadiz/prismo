...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[#08080A] text-white flex items-center justify-center p-4 relative overflow-hidden font-sans">
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="flex flex-col items-center mb-10 text-center">
          ...
          <h1 className="text-4xl font-extrabold tracking-tight mb-2">
            Welcome to <span className="bg-clip-text text-transparent bg-gradient-to-r from-red-500 via-yellow-400 via-green-400 via-blue-500 to-purple-600">Prismo AI</span>
          </h1>
        </div>
